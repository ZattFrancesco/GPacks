...
module.exports = {
  ...
  async execute(interaction) {
    ...
    if (!res.ok) return interaction.reply({ content: "❌ Erreur: palier introuvable.", ephemeral: true });

    return interaction.reply({ content: "✅ Rôles enregistrés pour ce palier.", ephemeral: true });
  },
};